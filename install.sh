...
wget -O sshd_config "https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/sshd_config"
...
#Mengintall Xray
cd /etc/xray
wget -q -O config.json "https://raw.githubusercontent.com/Nizwara/Xnew/main/config.json"
...
# Other
cd /usr/bin
wget -q -O m.zip "https://raw.githubusercontent.com/Nizwara/Xnew/main/menu.zip"
unzip m.zip
rm -fr m.zip
chmod +x *
cd /usr/bin/xwan
...
END
    ...
    rm -fr /etc/haproxy/haproxy.cfg
    wget -q -O /etc/haproxy/haproxy.cfg "https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/haproxy.cfg"
fi
...
#install latest xray
cd /usr/bin
wget -q https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/xray.zip
...
cd /etc/nginx 
rm -fr nginx.conf
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Nizwara/Xnew/main/nginx.conf"
cd
...
# Install Slowdns
cd
wget -q https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/slowdns.sh; chmod +x slowdns.sh; ./slowdns.sh; rm -fr slowdns.sh

# Install Chisel Proxy
cd
wget -q https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/chisel.sh; chmod +x chisel.sh; ./chisel.sh; rm -fr chisel.sh
...
cd /root; wget -O wgcf.sh "https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/install-warp.sh"; chmod +x /root/*; /root/wgcf.sh; rm -fr /root/*

# Install Backup Google Drive
cd /root
wget https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/set-br.sh
chmod +x /root/*
cd /root
./set-br.sh
rm -fr /root/*
...
#Install OpenVPN
cd
wget -q https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/vpn.sh && chmod +x vpn.sh && ./vpn.sh
...
wget -O /usr/bin/config.yaml "https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/config.yaml"
...
wget -q -O /usr/bin/ws "https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/ws.py"
...
wget -O /usr/bin/loop "https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/quota.sh"
...
wget -O /usr/bin/server "https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/server"
...
# Install OHP Server
wget -O /root/ohp.sh "https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/ohp.sh"
chmod +x /root/ohp.sh
cd /root
./ohp.sh
rm -fr /root/*
...
wget -O /root/proxy.sh "https://raw.githubusercontent.com/Nizwara/Xnew/main/bahan/other-proxy.sh"
